...
let lastAnalysisSettings: { isGreenScreen: boolean, isPngMode: boolean, isAnimeMode: boolean } | null = null;
...
1.  **Description (Title):** Concise, factual (8-15 words). Focus on actions, concepts, number of people, gender, ethnicity, and suitability for compositing. Ensure the description clearly indicates it's for "green screen" footage.${animeModeInstruction} Example: "Man in business suit pointing upwards, green screen video footage."
2.  **Keywords:** 20-35 relevant keywords. Include "green screen," "chroma key," "video footage," "isolated," actions, concepts, and subject details.
Output format: JSON array of objects. Each object: { "subject_focus": "Short identifier in English", "description": "Concise description for green screen in English", "keywords": ["keyword1 for green screen in English", "..."] }
...
1.  **Description (Title):** Concise, factual, SEO-optimized (8-15 words, max 200 chars).${animeModeInstruction} Example: "Gray and white Maine Coon cat on red velvet sofa, looking curious."
2.  **Keywords:** 20-35 most relevant, specific, descriptive keywords, ordered by importance.
Output format: JSON array of objects. Each object: { "subject_focus": "Short identifier in English", "description": "Concise description in English", "keywords": ["keyword1 in English", "..."] }
Ensure all text output is in English.`;
    }
